...
inline void MD5Update(MD5_CTX *context, unsigned char *input, unsigned int inputLen)//context buffer 8
{
...
void MD5Digest(uint8_t *pszInput, char *pszOutPut)//buffer user_key
{
  MD5_CTX context;
 
  MD5Init (&context);
  MD5Update (&context, (unsigned char *)pszInput, 8);
